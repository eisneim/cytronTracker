function multiply3x3(m1, m2) {
  var m11 = m1[0] * m2[0] + m1[1] * m2[3] + m1[2] * m2[6]
  var m12 = m1[0] * m2[1] + m1[1] * m2[4] + m1[2] * m2[7]
  var m13 = m1[0] * m2[2] + m1[1] * m2[5] + m1[2] * m2[8]
  var m21 = m1[3] * m2[0] + m1[4] * m2[3] + m1[5] * m2[6]
  var m22 = m1[3] * m2[1] + m1[4] * m2[4] + m1[5] * m2[7]
  var m23 = m1[3] * m2[2] + m1[4] * m2[5] + m1[5] * m2[8]
  var m31 = m1[6] * m2[0] + m1[7] * m2[3] + m1[8] * m2[6]
  var m32 = m1[6] * m2[1] + m1[7] * m2[4] + m1[8] * m2[7]
  var m33 = m1[6] * m2[2] + m1[7] * m2[5] + m1[8] * m2[8]
  return [
    m11, m12, m13,
    m21, m22, m23,
    m31, m32, m33,
